...
namespace DVLD_Project.Tests
{
    public partial class frmTakeTest : Form
    {
        ...
        {
            if (MessageBox.Show("Are you sure you want to save? This action cannot be undone", "Confirm!", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.Cancel)
            {
                return;
            }

...
namespace DVLD_Project.User
{
    public partial class frmListUsers : Form
    {
        ...
        {
            if(cbFilterBy.Text == "Active Status")
            {
        ...
        private void txtFilterValue_TextChanged(object sender, EventArgs e)
        {
            ...
            if (FilterColumn != "FullName" && FilterColumn != "UserName")
                _dtAllUsers.DefaultView.RowFilter = string.Format("[{0}] = {1}", FilterColumn, txtFilterValue);
            else
                _dtAllUsers.DefaultView.RowFilter = string.Format("[{0}] LIKE {1}%", FilterColumn, txtFilterValue);
        ...
        private void addANewUserToolStripMenuItem_Click(object sender, EventArgs e)
        {

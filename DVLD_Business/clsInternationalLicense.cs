...
namespace DVLD_Business
{
    public class clsInternationalLicense : clsApplication
    {
        ...
        {
            this.ApplicationTypeID = (int)clsApplication.enApplicationType.NewInternationalLicence;
...

        {
            ...
            base.ApplicationTypeID = (int)clsApplication.enApplicationType.NewInternationalLicence;

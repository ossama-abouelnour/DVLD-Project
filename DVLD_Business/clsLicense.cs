...
namespace DVLD_Business
{
    ...
    float PaidFees, bool IsActive, enIssueReason IssueReason, int CreatedByUserID)
        ...
        public clsLicense RenewLicense(string Notes, int CreatedByUserID)
        {
            ...
            Application.ApplicantPersonID = this.DriverInfo.PersonID;
            Application.ApplicationDate = DateTime.Now;
            Application.ApplicationTypeID = (int)clsApplication.enApplicationType.RenewDrivingLicence;
            Application.ApplicationStatus = clsApplication.enApplicationStatus.Completed;
            Application.LastStatusDate = DateTime.Now;
            Application.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.RenewDrivingLicence).Fee;
        ...
        {
            return clsLicenseData.GetLicenses(DriverID);
        }
    }
}
